...
const MyDrawer = ({ open, setOpen, username }) => {
  ...
  const list = () => (
    <div
      role="presentation"
      className="dark:bg-gray-500 h-full p-4 w-[250px]"
      onClick={()=>console.log(33333)}
>
      {username ? (
        ...
        <div className="h-full flex flex-col relative" onClick={()=>console.log('eie8e8')}>
          ...
          <Link
            href="/signup"
            className="bg-green-500 w-full px-4 absolute bottom-0 mx-auto rounded-3xl flex cursor-pointer py-2 dark:text-gray-300 gap-1 items-center justify-center text-[15px]"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
